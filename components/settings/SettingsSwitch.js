...
export default class SettingsSwitch extends Component {
    ...
    render() {
        ...
        const {
            container, containerStyle, titleProps, titleStyle, title, disabled, switchProps, disabledOverlayStyle,
            switchWrapperProps, switchWrapperStyle, value, thumbTintColor, onTintColor, onSaveValue,
        } = this.props;
